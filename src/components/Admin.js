...
function Admin() {
  ...
  // Balaji Enterprises Admin Credentials
  ...
  useEffect(() => {
    const savedAuth = localStorage.getItem('BalajiAdminAuth');
    const authTime = localStorage.getItem('BalajiAdminAuthTime');
    ...
    if (savedAuth === 'true' && authTime) {
      ...
      if (now < expiryTime) {
        ...
        localStorage.removeItem('BalajiAdminAuth');
        localStorage.removeItem('BalajiAdminAuthTime');
  ...
  const handleLogin = (e) => {
    ...
    if (loginData.username === ADMIN_CREDENTIALS.username && 
      ...
      setIsAuthenticated(true);
      setLoginError('');
      localStorage.setItem('BalajiAdminAuth', 'true');
      localStorage.setItem('BalajiAdminAuthTime', new Date().getTime().toString());
  ...
  const handleLogout = () => {
    localStorage.removeItem('BalajiAdminAuth');
    localStorage.removeItem('BalajiAdminAuthTime');
    localStorage.removeItem('BalajiAdminSession');
      ...
      <div className="admin-login-container">
        <div className="admin-login-box">
          <div className="login-header">
            ...
            <h1>Balaji Enterprises</h1>
            <p>Premium Furniture Brand</p>
  ...
  />
          ...
          <div className="login-footer">
            <p>📍 Premium Quality Furniture Since 1995</p>
            <p>📞 Call Us: +91 98722 28109</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="admin-header">
        <div className="admin-header-content">
          <div className="admin-title">
            ...
            <h1>Balaji Enterprises Admin Dashboard</h1>
            <span className="admin-badge">Premium Furniture Brand</span>
          </div>
          <div className="admin-contact-info">
            <span>📞 +91 98722 28109</span>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                ...
                <input
                  ...
                  required
                  placeholder="e.g., Premium Orthopedic Mattress, Executive Office Chair"
                />
              </div>
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  required
                  placeholder="Detailed description including features, materials, benefits, etc..."
                  rows="4"
                />
              </div>
                  ...
                  {showCategoryInput && (
                    <div className="new-category-input">
                      <input
                        ...
                        placeholder="Enter new category name (e.g., sofa-set)"
